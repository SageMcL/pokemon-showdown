...
export const Moves: {[moveid: string]: MoveData} = {
	...
	hiddenpowerelectric: {
		...
		basePower: 60,
		category: "Special",
		realMove: "Hidden Power (Electric)",
		isNonstandard: "Past",
	...
	hiddenpowerfighting: {
		...
		basePower: 60,
		category: "Special",
		realMove: "Hidden Power (Fighting)",
		isNonstandard: "Past",
	...
	spikes: {
		...
		condition: {
			...
			onEntryHazard(pokemon) {
				...
				} else this.damage(damageAmounts[this.effectState.layers] * pokemon.maxhp / 24);
			},
		},
		secondary: null,
		target: "foeSide",
